...
class Demo extends Component {
    ...
    render(){
        ...
        <div className="row" style={{marginTop: 10,display: "flex"}}>
            <ul className="collapsible" data-collapsible="accordion" style={{marginLeft: "4rem",width: "26rem"}}>
                <li className="btn_container">
                    <a className="waves-effect waves-light btn-large" onClick={this.draw.bind(this)}>渲染</a>
                </li>
            </ul>
            <div className="col s12 m7" style={{float: "right",marginRight: "4rem"}}>
                <div className="card">
                    <div id="container" className="card-image container">
                        <span className="card-title" style={{color: "#868181"}}>Knowlegde Graph</span>
                    </div>
                    <div className="card-content" style={{background: "aliceblue"}}>
                        <p>知识图谱可视化，基于d3.js构建，支持数据导入与配色选择</p>
                    </div>
                    <div className="card-action">
                        <a style={{color: "#077abd"}} href="http://www.molapages.xyz">mola的博客</a>
                    </div>
                </div>
            </div>
        </div>
